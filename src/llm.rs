...
/// Delegate to [`crate::tool_xml::parse_xml_tool_calls_from_content`].
fn parse_xml_tool_calls_from_content(content: &str) -> Vec<ToolCall> {
    crate::tool_xml::parse_xml_tool_calls_from_content(content)
}

/// Delegate to [`crate::tool_xml::contains_tool_xml_syntax`].
pub(crate) fn contains_tool_xml_syntax(text: &str) -> bool {
    crate::tool_xml::contains_tool_xml_syntax(text)
}

/// Delegate to [`crate::tool_xml::strip_xml_tool_call_blocks`].
pub fn strip_xml_tool_call_blocks(content: &str) -> String {
    crate::tool_xml::strip_xml_tool_call_blocks(content)
}
...
mod tests {
    ...
    // XML tool call tests now live in tool_xml::tests
